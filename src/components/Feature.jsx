...
<div class="max-w-3xl max-md:max-w-xl mx-auto p-4 font-[sans-serif]">
      <h2 class="text-gray-800 text-3xl font-extrabold text-center">Our Features</h2>
      <div class="mt-16 space-y-10">
        <div class="grid md:grid-cols-2 gap-14">
          <div>
            ...
            <p class="text-gray-600 text-sm leading-relaxed">Qui elit labore in nisi dolore tempor anim laboris ipsum ad ad consequat id. Dolore et sint mollit in nisi tempor culpa consectetur.</p>
          </div>
        ...
        <div class="grid md:grid-cols-2 gap-14">
          ...
          <div class="h-[230px]">
            <img src="https://readymadeui.com/Imagination.webp" class="w-full h-full object-cover rounded-xl" />
          </div>
        </div>
      </div>
    </div>
