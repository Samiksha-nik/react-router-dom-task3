...
<div class="font-[sans-serif] p-4">
            <div class="max-w-3xl max-md:max-w-md mx-auto">
                <h2 class="text-gray-800 text-4xl font-extrabold">The Team</h2>

                <div class="grid md:grid-cols-3 sm:grid-cols-2 gap-8 max-sm:justify-center text-center mt-12">

                    <div class="bg-gray-200 max-w-[230px] rounded-tl-full rounded-tr-full">
                        <img src="https://readymadeui.com/team-1.webp" class="rounded-full" />

                        <div class="p-4">
                            <h4 class="text-gray-800 text-base font-bold">John Doe</h4>
                            <span class="text-gray-600 text-xs mt-1">Software Engineer</span>
                            <p class="mt-4 text-gray-600 text-sm">Eiusmod commodo aliquip laboris qui anim non voluptate consectetur.</p>
                    ...
                    <div class="bg-gray-200 max-w-[230px] rounded-tl-full rounded-tr-full">
                        <img src="https://readymadeui.com/team-3.webp" class="rounded-full" />

                        <div class="p-4">
                            <h4 class="text-gray-800 text-base font-bold">Simon Konecki</h4>
                            <span class="text-gray-600 text-xs mt-1">Web Designer</span>
                            <p class="mt-4 text-gray-600 text-sm">Eiusmod commodo aliquip laboris qui anim non voluptate consectetur.</p>
